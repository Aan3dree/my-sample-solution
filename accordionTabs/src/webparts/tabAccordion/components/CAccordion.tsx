...
export default class CAccordion extends React.Component<ICAccordionProps, {}> {
  ...
  public componentDidMount(): void {
    const parentElement = document.querySelector('#wpAcordeon');
    if (parentElement) {
             ...
             <AccordionItem key={"tab" + index} className={styles.accordion__item} aria-controls={this.props.guid + '-title-' + index} id={"tab" + index} >
                  ...
                  <Editor
                          ...
                          init={{
                            ...
                            height : "240",
                            toolbar: 'undo redo | bold italic | alignleft aligncenter alignright | numlist bullist | image media | table |code',
